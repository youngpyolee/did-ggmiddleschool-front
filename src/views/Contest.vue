          ...
          <div class="modal-content-inner">
            <div class="modal-content-body" ref="modalContentBodyRef">
              ...
              <ul class="competi-list" v-for="data in dataList" :key="data.seq">
                ...
                <li>
                  <a href="javascript:void(0)" @touchmove="selectTouchClick" @click="selectDetailClick($event,data)" @touchend="selectDetailClick($event,data)">
...
export default {
  ...
  setup(props,context){
    ...
    const connectInitFunc = async (subItem)=> {
      ...
      dataList.value=storeData.state.dataStore.contestStateList;
     }

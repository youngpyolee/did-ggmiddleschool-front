        ...
        <div class="modal-content-outer">
          <div class="modal-content-inner">
            ...
            <div class="modal-content-header">
              ...
              <div class="infobox"><span class="date">{{ detailData.date }}</span></div>
            </div>
            <div class="modal-content-body">
              <div class="iframe-outer">
                <iframe :src="detailData.url" frameborder="0"></iframe>
              </div>
            </div>
            <!-- //내용 -->
          </div>
...
export default {
  ...
  setup(props,context) {
    ...
    const selectCloseClick = (event)=>{
      ...
      activeYn.value=false;
      storeData.dispatch("modalPopStore/modalProcStateAction" , {"stateNm":"noticeInfoDetailState","stateYn":false});

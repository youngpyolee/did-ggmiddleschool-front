          ...
          <div class="modal-content-inner">
            ...
            <div class="modal-content-body">
              <div class="competi-detail-outer">
                ...
                <div class="competi-detail-inner" id="competiDetailInnerId" ref="competiDetailInnerRef">
                  <strong>주제</strong>
...
export default {
  ...
  setup(props,context){
    ...
    const selectCloseClick = (event)=>{
      ...
      storeData.dispatch("modalPopStore/modalProcStateAction" , {"stateNm":"extrnlActDetailState","stateYn":false});
